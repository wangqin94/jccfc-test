...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.weiCaiCheckBizImpl = JiRoCheckBizImpl(data=self.data)
    ...
    def test_apply(self, loan_date='2023-04-03'):
        ...
        jiro = JiRoBizImpl(data=self.data)
        # 绑卡签约
        ...
        # 接口层校验授信结果是否符合预期
        self.weiCaiCheckBizImpl.jiro_check_credit_apply_status(self.thirdApplyId)
        ...
        # 接口层校验授信结果是否符合预期
        status = self.weiCaiCheckBizImpl.jiro_check_loan_apply_status(self.thirdApplyId)
