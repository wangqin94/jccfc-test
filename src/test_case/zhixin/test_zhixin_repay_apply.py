...
class MyTestCase(unittest.TestCase):
    ...
    def test_repay_apply(self):
        ...
        # self.repayRes = json.loads(zhixin.applyRepayment(loan_no=loan_apply_info['loan_apply_id'], repay_type='2', repayTime='20211224111111').get('output'))  # 提前结清
        # self.repayRes = json.loads(zhixin.applyRepayment(loan_no=loan_apply_info['loan_apply_id'], repay_type='3', repayAmt='511.94', repayTime='20211217111111').get('output')) # 逾期还款
