...
class MyTestCase(unittest.TestCase):
    ...
    def test_repay_apply(self):
        ...
        # 还款环境配置
        self.repayPublicBizImpl.pre_repay_config(repayDate='2023-03-24')
        ...
        self.repayRes = jike.repay_apply(repay_scene='01', repay_type='7', loanInvoiceId=credit_loan_invoice['loan_invoice_id'], repayGuaranteeFee=1.11, repayDate='2023-03-24')  # 按期还款
