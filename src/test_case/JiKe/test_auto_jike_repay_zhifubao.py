...
class TestCase(object):
    ...
    def test_billDate_repay(self, jikeBizImpl, jikeLoanApply, mysqlBizImpl, checkBizImpl, jikeCheckBizImpl):
        ...
        with allure.step("发起银行卡还款请求"):
            self.repayRes = jikeBizImpl.repay_apply(repay_scene='04', repay_type='1', loanInvoiceId=loanInvoiceId, repayDate=repayDate, repayTerm=repayTerm)  # 按期还款
    ...
    def test_advance_repay(self, jikeBizImpl, mysqlBizImpl, checkBizImpl, jikeCheckBizImpl):
        ...
        with allure.step("发起银行卡还款请求"):
            self.repayRes = jikeBizImpl.repay_apply(repay_scene='04', repay_type='7', loanInvoiceId=loanInvoiceId, repayDate=repayDate, repayTerm=repayTerm)  # 按期还款
    ...
    def test_advance_settle_repay(self, jikeBizImpl, mysqlBizImpl, checkBizImpl, jikeCheckBizImpl):
        ...
        with allure.step("发起银行卡还款请求"):
            self.repayRes = jikeBizImpl.repay_apply(repay_scene='04', repay_type='2', loanInvoiceId=loanInvoiceId, repayDate=repayDate, repayTerm=repayTerm)  # 按期还款
