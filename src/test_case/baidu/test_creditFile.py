...
class MyTestCase(unittest.TestCase):
    ...
    def test_one(self, flag=1):
        ...
        if flag == 0:
            ...
            bd = BaiduFile(data, cur_date='20210901', loan_record=1, repay_mode='02')
            bd.start()
        ...
        # 生成还款文件、更新还款计划、减免文件
            ...
            bd = BaiduRepayFile(data, repay_mode='02', repay_date="2021-09-10", repay_term_no=1,
                                repay_type='04', loan_invoice_id=None)
            bd.start_repay_file()
