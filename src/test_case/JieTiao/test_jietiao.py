...
class TestCase(object):
    ...
    def process(self, flag=1):
        ...
        # 还款通知接口
            ...
            jt = JieTiaoBizImpl(data=None)
            jt.repay_notice(rpyType='', rpyTerm='', rpyReqNo='11111111111', tranNo='', rpyDate='', rpyPrinAmt='', rpyIntAmt='', rpyOintAmt='', rpyDeductAmt='0', rpyRedLineAmt='0', ifEnough='0',rpyChannel='0')
