...
class MyTestCase(unittest.TestCase):
    ...
    """ 测试步骤 """
    def test_repay_apply(self, repayDate="2023-08-20"):
        """ 测试步骤 """
        ...
        self.repayRes = XiaoX.repay_apply(repay_scene='01', repay_type='2', loanInvoiceId=credit_loan_invoice['loan_invoice_id'], repayGuaranteeFee=30, repayDate=repayDate)  # 按期还款
