...
class TestCase(object):
    ...
    def process(self, flag=3):
        ...
        # 借款申请
            ...
            XiaoX = XiaoXBizImpl(data=data)
            XiaoX.applyLoan(loanAmt=1000, loanTerm=12, reserveMobile='16100001955', thirdApplyId='thirdApplyId16708148970374646')

        # 借款查询
        elif flag == 6:
            XiaoX = XiaoXBizImpl(data=data)
            XiaoX.queryLoanResult(thirdApplyId='202210131431422562436865')

        # 还款计划查询
        elif flag == 7:
            XiaoX = XiaoXBizImpl(data=data)
            XiaoX.repayPlan_query(loanInvoiceId='000LI0002174662201688190001')

        # 借据合同查询
        elif flag == 8:
            XiaoX = XiaoXBizImpl(data=data)
            XiaoX.loanContract_query(loanInvoiceId='000LI0001408714913972228005')
        ...
        # LPR查询
            ...
            XiaoX = XiaoXBizImpl(data=data)
            XiaoX.queryLprInfo("thirdApplyId16708148970374646")
