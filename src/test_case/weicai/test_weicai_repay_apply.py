...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.weiCaiCheckBizImpl = WeiCaiCheckBizImpl(data=data)
    ...
    def tearDown(self):
        # 接口层校验授信结果是否符合预期
        status = self.weiCaiCheckBizImpl.weicai_check_repay_status(self.repayRes['body']['repayApplySerialNo'])
