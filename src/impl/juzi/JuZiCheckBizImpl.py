...
class JuZiCheckBizImpl(JuZiBizImpl):
    def __init__(self, data=None, person=False):
        super().__init__(data=data, person=person)

    def juzi_check_credit_apply_status(self, thirdApplyId):
        """
    ...
    def juzi_check_loan_apply_status(self, thirdApplyId):
        """
        @param thirdApplyId:  授信申请单号
        @return:
        """
    ...
    def juzi_check_repay_status(self, repayApplySerialNo):
        """
