...
class creditFile(EnvInit):
    ...
    def start_creditFile(self, apply_type='ADMIT_APPLY', creditAmt='1000000', creditRate='0.00060'):
        if apply_type == 'ADMIT_APPLY':
            ...
            applyNo = self.creditNo.replace('applyno', 'amtNo')
        result = '''{"approvalResult":"Y","approvalResultCode":"","approvalResultMsg":"","creditAmt":%s,"creditRate":%s,"extInfo":"{}"}''' % (creditAmt, creditRate)
        ...
        '{}', '{}', 'PASS', '{}', '{}','{}', '{}', '{}', '00', '', 0, 'system', now(), 'system', now());''' \
            .format(applyNo, self.creditNo, apply_type, self.name, self.certNo, self.telephone, self.applyDate,
