...
class HaLoCheckBizImpl(HaLoBizImpl):
    ...
    def halo_check_credit_apply_status(self, thirdApplyId):
        """
    ...
    def halo_check_loan_apply_status(self, thirdApplyId):
        """
        @param thirdApplyId:  授信申请单号
        @return:
        """
    ...
    def halo_check_repay_status(self, repayApplySerialNo):
        """
