...
class JiRoCheckBizImpl(JiRoBizImpl):
    def __init__(self, data=None, person=False):
        super().__init__(data=data, person=person)

    def jiro_check_credit_apply_status(self, thirdApplyId):
        """
    ...
    def jiro_check_loan_apply_status(self, thirdApplyId):
        """
        @param thirdApplyId:  授信申请单号
        @return:
        """
    ...
    def jiro_check_repay_status(self, repayApplySerialNo):
        """
