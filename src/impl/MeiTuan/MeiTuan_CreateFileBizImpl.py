...
if __name__ == '__main__':
    # 美团按期还款、提前结清，按日收息
    data = {'name': '殷可', 'cer_no': '440281198110165525', 'bankid': '6217852962028107351', 'telephone': '13452374601',
            'app_no': 'mt_app_no16315033450041002'}  # hpre -> MeiTuan
    card_id = data['cer_no']
    user_name = data['name']
    t = MtFile(certificate_no=card_id, user_name=user_name, loan_record=0, apply_date='2021-08-19')
