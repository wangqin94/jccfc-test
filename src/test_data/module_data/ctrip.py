        ...
        'payload': {
            ...
            "user_data": {
                "Platform": {
                    ...
                    "id_no": "${身份证号}",
                    "personIncome": "10-20万元",
                    "idcard_ocr_addr": "四川省成都市武侯区府城大道中段88号",
                    "idcard_ocr_gender": "M",
                    # "identity_card_image_1": "2359ccde79b0659845f6dabd5dca60e8",
                    # "identity_card_image_2": "295ee79a784a141c62ea7d3aa909b9ad",
                    # "face_image": "ea99e04f998b1ede8677ca7311a7bf5c",
                    # "nationality": "Chinese",
                    "contact_relate": "配偶",
                    "user_name": "${姓名}",
                    "contacts_mobile": "15210120098",
    ...
    'loan': {
        ...
        'payload': {
            ...
            "extend_param": {
                ...
                "loanAppRating": '优',
                "riskGrade": 1,
                "risk_data": "{\"masterGrade\":\"E\",\"riskGrade\":\"1\",\"MultiApplicationRating\":\"3\"}"
            }
        }
    },
