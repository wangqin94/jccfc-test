...
class AllTest():
    def __init__(self):
        global log, logger, resultPath, on_off, email_send_model
        ...
        self.case_path = readconfig.get_path("case_path")
        self.caseListFile = os.path.join(project_dir(), self.case_path, "caselist.txt")
        self.caseFile = os.path.join(project_dir(), "test_Case")
        self.caseList = []
    ...
    def set_case_suite(self, case):
        ...
        logger.info("此次执行的测试文件清单" + case_name + ".py")
